...
public class IGoUI extends Application {
        ...
        private void showMaintenanceLogin() {
                ...
                loginBtn.setOnAction(e -> {
                        if (maintenanceService.authenticate(pinField.getText())) {
                                fadeTransition(layout, () -> showMaintenanceDashboard());
                        } else {
                                errorLabel.setText(
                ...
                Button backBtn = createActionButton(
                                ...
                                ERROR_COLOR,
                                false);
                backBtn.setOnAction(e -> fadeTransition(layout, () -> showMainMenu()));
        ...
        private void showLanguageSelection() {
                ...
                englishBtn.setOnAction(e -> {
                        ...
                        fadeTransition(content, () -> showMainMenu());
                });
        ...
        private void showMainMenu() {
                ...
                Button maintenanceBtn = createMenuButton(
                                ...
                                "🔧");
                checkBalanceBtn.setOnAction(e -> fadeTransition(layout, () -> showCheckBalanceScreen()));

                content.getChildren().addAll(buyTicketBtn, rechargeBtn, checkBalanceBtn, maintenanceBtn);
                layout.setCenter(content);

                maintenanceBtn.setOnAction(e -> fadeTransition(layout, () -> showMaintenanceLogin()));
        ...
        private void showBuyTicketScreen() {
                ...
                sessionManager.startSession(() -> {
                        ...
                        pause.setOnFinished(e -> fadeTransition(layout, () -> showMainMenu()));
                        pause.play();
                });
        ...
        private HBox createFooter() {
                ...
                languageButton.setOnAction(e -> {
                        ...
                        fadeTransition(mainContainer, () -> showMainMenu());
                });
